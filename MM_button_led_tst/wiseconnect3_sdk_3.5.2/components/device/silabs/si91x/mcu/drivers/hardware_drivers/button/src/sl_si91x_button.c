...
#define SL_SI91X_BUTTON_DEBOUNCE 1 // Enable debounce functionality for button interrupts. This adds a 2ms delay in the ISR to mitigate mechanical bounce effects.
...
void sl_si91x_button_internal_isr(const sl_button_t *handle)
{
  ...
  sl_si91x_delay_ms(50); // Introduces a 2ms delay to mitigate button debounce effects.
