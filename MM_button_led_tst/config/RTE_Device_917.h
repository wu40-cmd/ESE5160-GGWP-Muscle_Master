 ...
 * $Revision:    V2.4.4
 *
 * Project:      RTE Device Configuration for SiWG917 IC/Module OPNs
 * -------------------------------------------------------------------------- */
...
#define RTE_LED0_PIN (0U)
#else
#define RTE_LED0_PIN (2U)
#endif

#define RTE_LED1_PORT   HP
#define RTE_LED1_NUMBER 1
#define RTE_LED1_PIN    (10U)
#ifdef SL_SI91X_ACX_MODULE
#define BOARD_ACTIVITY_LED (0U) // LED0
#else
...
/*UART1 PINS*/
//     <o> UART1_TX <0=>P0_7 <1=>P0_30 <2=>P0_69 <3=>P0_73 <4=>P0_75 <5=>P0_34
//     <i> TX of UART1
#ifndef UART1_TX_LOC
#ifdef SLI_SI91X_MCU_CONFIG_RADIO_BOARD_BASE_VER
...
//     <o> UART1_RX <0=>P0_6 <1=>P0_29 <2=>P0_66 <3=>P0_72
//     <i> RX of UART1
#ifndef UART1_RX_LOC
...
#ifdef SL_SI91X_ACX_MODULE
#error "ULP_GPIO_10 is not available in module boards/OPNs!"
#else
#define RTE_UART1_RX_PORT HP
...
// <o> I2C1_SCL Pin <0=>P0_7 <1=>P0_30 <2=>P0_51 <3=>P0_55  <4=>P0_65 <5=>P0_71 <6=>P0_34
#ifndef I2C1_SDA_LOC
...
// PWM_FAULTB <0=>GPIO_26 <1=>GPIO_74
...
//Pintool data
#endif
//OPAMP3_P <0=>GPIO_29 <1=>ULP_GPIO_10
#ifndef OPAMP3_P_LOC
...
#elif (RTE_OPAMP3_P_PORT_ID == 1)
#define RTE_OPAMP3_P_PIN      74
#define RTE_OPAMP3_P_PORT     HP
#define RTE_OPAMP3_P_PORT_MUX 7
#else
...
#endif
#if (OPAMP3_P_LOC == 1)
#define RTE_OPAMP3_P_PIN      (OPAMP3_P_PIN + GPIO_MAX_PIN)
#define RTE_OPAMP3_P_PORT_MUX 7
#endif
//Pintool data
#endif

//OPAMP3_N <0=>ULP_GPIO_10
#ifndef OPAMP3_N_LOC
#define RTE_OPAMP3_N_PORT_ID 0
#if (RTE_OPAMP3_N_PORT_ID == 0)
#define RTE_OPAMP3_N_PIN      74
#define RTE_OPAMP3_N_PORT     HP
#define RTE_OPAMP3_N_PORT_MUX 7
#else
#error "Invalid OPAMP3_N_PIN"
#endif
#else
//Pintool data
#define RTE_OPAMP3_N_PORT HP
#if (OPAMP3_N_LOC == 2)
#define RTE_OPAMP3_N_PIN      (OPAMP3_N_PIN + GPIO_MAX_PIN)
#define RTE_OPAMP3_N_PORT_MUX 7
#endif
//Pintool data
#endif

//OPAMP3_RES <0=>GPIO_29 <1=>ULP_GPIO_10
...
#elif (RTE_OPAMP3_RES_PORT_ID == 1)
#define RTE_OPAMP3_RES_PIN      74
#define RTE_OPAMP3_RES_PORT     HP
#define RTE_OPAMP3_RES_PORT_MUX 7
#else
...
#endif
#if (OPAMP3_RES_LOC == 4)
#define RTE_OPAMP3_RES_PIN      (OPAMP3_RES_PIN + GPIO_MAX_PIN)
#define RTE_OPAMP3_RES_PORT_MUX 7
#endif
//Pintool data
#endif
...
#define SENSOR_ENABLE_GPIO_PORT RTE_ULP_GPIO_2_PORT
#define SENSOR_ENABLE_GPIO_PIN  RTE_ULP_GPIO_2_PIN
#else
